...
function c({
    ...
    const a = "inline-flex items-center justify-center font-medium rounded-xl transition-all duration-200 cursor-pointer whitespace-nowrap",
        b = {
        ...
        i = e ? "opacity-50 cursor-not-allowed" : "";
    return x.jsx("button", {
        type: n,
        onClick: o,
        disabled: e,
        className: `${a} ${b[r]} ${u[s]} ${i} ${l}`,
        children: t
    })
}
export {
...
//# sourceMappingURL=Button-BwOLboJ4.js.map