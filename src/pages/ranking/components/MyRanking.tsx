      ...
      <Card className="p-4 md:p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="text-center p-3 bg-white rounded-lg border border-gray-100">
            ...
            <p className="text-xl font-bold text-gray-900">{myStats.weekly.rank}위</p>
            <p className="text-xs text-gray-500">거리: {myStats.weekly.distance}</p>
          </div>
          <div className="text-center p-3 bg-white rounded-lg border border-gray-100">
            <p className="text-sm text-gray-600">월간 순위</p>
            <p className="text-xl font-bold text-gray-900">{myStats.monthly.rank}위</p>
            <p className="text-xs text-gray-500">거리: {myStats.monthly.distance}</p>
          </div>
        </div>
        ...
        <div className="mb-6 p-4 bg-orange-50 rounded-xl border border-orange-100">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-orange-900">1위와의 차이</span>
            <span className="text-lg font-bold text-orange-600">{myStats.weekly.gap}</span>
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-900">월간 목표 달성률</span>
            <span className="text-sm font-bold text-blue-600">{myStats.goal.percentage}%</span>
          </div>
      ...
      {showReportModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <Card className="max-w-sm w-full p-6 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">PDF 리포트 생성 중</h3>
